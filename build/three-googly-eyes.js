var GooglyEyes = (function (three) {
    ...
    class EyePhysics {
        constructor(target, eyeRadius, irisRadius) {
            ...
            this._worldPos = target.getWorldPosition(new three.Vector3());
    ...
    class GooglyEyes extends three.Group {
        constructor(eyeRadius = 0.02, eyeSpacing = 0.05, irisRadius = undefined, inwardRotation = 0.1, materialType) {
            ...
            const whiteGeom = new three.SphereBufferGeometry(eyeRadius, 6, 12, Math.PI, Math.PI * 2);
            const blackGeom = new three.SphereBufferGeometry(irisRadius, 6, 12);
            const transGeom = new three.SphereBufferGeometry(eyeRadius, 6, 12, 0, Math.PI);
